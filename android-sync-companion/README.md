...
This app is not a full mobile dashboard. It only imports Health Connect exercise sessions into the existing MyDash Firebase user path.
...
- Health Connect import currently reads the last 30 days only.
- Route, laps, and cadence are not imported in this first prototype.
